## Create visualizations for the proportion of joy tweets per month
...
# read in files containing containing total and joy tweet counts per month
...
# create a bar graph for the proportion of joy tweets per month
